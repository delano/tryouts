...
A BBQ started nearby as I was writing this documentation. It's incomplete and I'm sorry about that but I can tell you that this BBQ smells really, really good. 
...
* Tryout: a set of drills.
* Drill: a test, like a basketball. 
...
Tryouts tests command-line applications by comparing expected output with the actual output. Let's say we have an executable called mockout and we want to test the following commands:
    ...
    $ bin/mockout
    $ bin/mockout info 
    $ bin/mockout -f yaml info
    
The tryout definition would look like this:

    command :mockout, "bin/mockout"
...
Tryouts does some funky stuff to make it simple to write and run tests. This "funky 
